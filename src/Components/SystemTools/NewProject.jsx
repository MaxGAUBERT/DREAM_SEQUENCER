...
const NewProject = ({ onNewProject = () => {} }) => {
    ...
    // Charger les projets existants depuis l'état (pas localStorage dans Claude)
    useEffect(() => {
        // Simulation des projets existants
        setExistingProjects(["Project Demo", "My Beat", "Electronic Mix"]);
    }, []);
